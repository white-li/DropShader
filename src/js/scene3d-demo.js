    ...
    window.initScene3d = function (model) {
        ...
        function createModel(obj) {
            ...
            var mat = new THREE.ShaderMaterial( {
                vertexShader:   document.getElementById( 'vertexshader_geom' ).textContent,
                fragmentShader: document.getElementById( 'fragmentshader_geom' ).textContent,
                fog: false
            });
            var mesh = modelCont.children[0];
            mesh.material = mat;
            scene.add(modelCont);
        }
